...
import type { RenderMode } from '@velo/http';

// ─── Re-export from @velo/security (backward compat) ────────────────────
export type { MiddlewareFn, CorsOptions, RateLimitOptions } from '@velo/security';
export {
  withHeaders,
...
import type { MiddlewareFn } from '@velo/security';
...
import { withHeaders } from '@velo/security';
