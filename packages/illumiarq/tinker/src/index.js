...
export function readAppName(cwd) {
...
export async function loadTinkerContext(cwd) {
  const context = {};
  const loaded = [];
...
export async function evalCode(code, context = {}) {
 ...
 */
export async function startTinker(config = {}) {
...
export async function tinker(cwd = process.cwd()) {
