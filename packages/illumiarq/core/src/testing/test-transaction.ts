 ...
 *
 * Set by `withTestContext()` in `@illumiarq/runtime`.
 * Read by `BaseRepository.db` getter in `@illumiarq/database`.
 *
 * Typed as `Record<string, unknown>` to keep `@illumiarq/core` free of any ORM
